...
dependencies {
    ...
    // encoder PCM -> MP3 buat fitur record. Exclude com.android.support: TAndroidLame
    // masih narik support-compat lama yang isi class-nya bentrok (duplicate class)
    // sama androidx.core yang udah kita pakai di atas.
